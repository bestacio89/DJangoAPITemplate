...
<<<<<<<< HEAD:DjangoAPITemplate/users/tests/test_views.py
...
========
from djangoapitemplate.infrastructure.users.forms import UserAdminChangeForm
from djangoapitemplate.infrastructure.users.models import User
from djangoapitemplate.infrastructure.users.tests.factories import UserFactory
from djangoapitemplate.infrastructure.users.views import UserRedirectView
from djangoapitemplate.infrastructure.users.views import UserUpdateView
from djangoapitemplate.infrastructure.users.views import user_detail_view
>>>>>>>> main:djangoapiwithdeeplearning/infrastructure/users/tests/test_views.py
